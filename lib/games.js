...
Meteor.methods({
    ...
    'games.insert' : function (st, gameid, user) {
        ...
        Games.insert({
            ...
            id: gameid, // unique id of game
            gameWon: -1, // flag to track who has won the game (if anyone). -1: no one has won; 0: player 1 wins; 1: player 2 wins
        });
    },

    /**
     * Sets the flag of who has won the game.
     * @param id unique game id
     * @param value -1: no one has won; 0: player 1 wins; 1: player 2 wins
     */
    'games.setGameWon' : function (id, value) {
        Games.update({id: id}, {$set: {gameWon: value}});
    },
